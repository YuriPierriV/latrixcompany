        ...
        >
          {hovered && (
            <>
              ...
              <stop offset="25%" stopColor={"#7447e1"} />
              <stop offset="50%" stopColor={"#7447e1"} />
              <stop offset="75%" stopColor={"#7447e1"} />
              <stop offset="100%" stopColor={"#7447e1"} />
            </>
          )}
        </linearGradient>
